...
description: Saiba mais sobre o lançamento do Cloud Manager 2026.4.0 no Adobe Managed Services.
...
# Notas de versão do Cloud Manager 2026.4.0 no Adobe Managed Services {#release-notes}

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Saiba mais sobre o lançamento do [!UICONTROL Cloud Manager] 2026.4.0 no Adobe Managed Services.
...
A data de lançamento do [!UICONTROL Cloud Manager] 2026.4.0 é quinta-feira, 2 de abril de 2026.
<!-- There are no significant new features or bug fixes in the May Cloud Manager release. -->

A próxima versão planejada é quinta-feira, 7 de maio de 2026.
...
Não há correções de bugs significativas na versão de abril de 2026 do Cloud Manager no AMS.
