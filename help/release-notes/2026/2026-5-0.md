...
Para obter acesso exclusivo aos recursos futuros antes do lançamento geral, você pode participar dos programas beta da Cloud Manager.
...
Um novo modelo de criação compila apenas módulos alterados (em vez do repositório inteiro) usando o armazenamento em cache no nível do módulo, o que reduz os tempos de criação. Ela se aplica aos pipelines de Qualidade de código e Pilha completa.
