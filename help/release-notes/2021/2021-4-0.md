...
A data de lançamento do [!UICONTROL Cloud Manager] A versão 2021.4.0 é 8 de abril de 2021.
...
* Durante a etapa de implantação da página de execução do pipeline, o usuário poderá ver as etapas de implantação concluídas e futuras, além da etapa atual na interface do *Em andamento* estado.
...
* Erros transitórios e raros que podem ocorrer em *Teste de ativos* etapa no pipeline de produção.
