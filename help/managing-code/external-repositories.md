...
1. Na caixa de diálogo **Adicionar repositório**, selecione **Repositório privado** para vincular um repositório Git externo ao seu programa.
   ...
   ![Adicionar repositório próprio](/help/managing-code/assets/repository-add-private-dialogbox2.png)
...
1. Na página **Repositórios**, usando a coluna **Tipo** para orientá-lo na sua seleção, localize o repositório desejado e clique em ![Reticências - Ícone Mais](https://spectrum.adobe.com/static/icons/workflow_18/Smock_More_18_N.svg) ao lado dele.
   ...
   ![Opção de Webhook de configuração no menu suspenso para um repositório selecionado](/help/managing-code/assets/repository-config-webhook.png)

1. No menu suspenso, clique em **Configurar Webhook**.

   ![Caixa de diálogo Configurar Webhook](/help/managing-code/assets/config-webhook.png)
...
| --- |
| Esses eventos permitem que o Cloud Manager responda à atividade do GitHub, como validação de solicitação pull, acionadores baseados em push para pipelines ou sincronização de código do Edge Delivery Services.<br>Verifique se o webhook está configurado para acionar os seguintes eventos do webhook:<ul><li>Solicitações de pull<li>Envios por push<li>Comentários do problema</li></li></li></ul></ul></ul> |
...
| Eventos de webhook necessários |
| --- |
| Esses eventos de webhook permitem que o Cloud Manager acione pipelines quando o código é enviado por push ou uma solicitação de mesclagem é enviada. Eles também rastreiam comentários relacionados à validação da solicitação de pull (por meio de eventos de anotações).<br>Verifique se o webhook está configurado para acionar os seguintes eventos de webhook necessários<ul><li>Eventos de push<li>Mesclar eventos de solicitação<li>Anotar eventos</li></li></li></ul></ul></ul> |
...
![Quando a validação de qualidade do código falha com um erro](/help/managing-code/assets/repository-webhook-gitlab3.png)
...
![Status enquanto a validação de qualidade do código está em execução](/help/managing-code/assets/repository-webhook-bitbucket1.png)
