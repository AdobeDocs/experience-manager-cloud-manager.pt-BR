...
* O Maven é configurado no nível do sistema com um arquivo settings.xml que inclui automaticamente o repositório Adobe público **Artifato**.
Consulte [Repositório Maven Público do Adobe](https://repo.adobe.com/) para obter mais detalhes.
