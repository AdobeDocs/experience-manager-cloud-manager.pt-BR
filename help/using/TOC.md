...
user-guide-title: Guia do gerenciador da Experience Manager Cloud
...
# Guia do Gerenciador de nuvem {#using}
...
+ Notas de versão {#release-notes}
   + [Notas de versão atuais (2020.10.0)](release-notes-current.md)
