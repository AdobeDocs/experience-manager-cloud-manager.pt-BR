...
Um novo modelo de build compila apenas módulos alterados (em vez de todo o repositório) usando o armazenamento em cache no nível do módulo, reduzindo os tempos de compilação. Ela se aplica aos pipelines de Qualidade de código e Pilha completa.
