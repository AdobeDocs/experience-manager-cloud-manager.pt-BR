...
A data de lançamento do [!UICONTROL Cloud Manager] 2018.9.0 é sexta-feira, 1 de novembro de 2018.
...
* A barra lateral de Notificação do Adobe [!UICONTROL Experience Cloud] pode não carregar notificações consistentemente. As notificações, no entanto, estão visíveis no Adobe [!UICONTROL Experience Cloud] e, se configuradas, ainda são enviadas por email.
