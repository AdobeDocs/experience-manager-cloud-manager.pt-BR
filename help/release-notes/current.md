...
description: Saiba mais sobre o lançamento do Cloud Manager 2026.1.0 no Adobe Managed Services.
...
# Notas de versão do Cloud Manager 2026.1.0 no Adobe Managed Services {#release-notes}

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Saiba mais sobre o lançamento do [!UICONTROL Cloud Manager] 2026.1.0 no Adobe Managed Services.
...
A data de lançamento do [!UICONTROL Cloud Manager] 2026.1.0 é sexta-feira, 22 de janeiro de 2026.
...
Não há correções de bugs significativas na versão de janeiro de 2026 do Cloud Manager no AMS.
