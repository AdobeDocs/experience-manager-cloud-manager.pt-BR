---
title: Notas de versão do Cloud Manager 2026.8.0
description: Saiba mais sobre o lançamento do Cloud Manager 2026.8.0 no Adobe Managed Services.
...
# Notas de versão do Cloud Manager 2026.8.0 no Adobe Managed Services {#release-notes}

<!-- add "hold: true" to metadata above to be able to commit/merge to Main WITHOUT Publishig -->

<!-- RELEASE WIKI  https://wiki.corp.adobe.com/display/DMSArchitecture/Cloud+Manager+2025.04.0+Release -->

Saiba mais sobre a versão do [!UICONTROL Cloud Manager] 2026.8.0 no Adobe Managed Services.
...
A data de lançamento do [!UICONTROL Cloud Manager] 2026.8.0 é quinta-feira, 6 de agosto de 2026.
<!-- There are no significant new features or bug fixes in the May Cloud Manager release. -->

A próxima versão planejada é quinta-feira, 3 de setembro de 2026.
