...
>[!TIP]
>
>Consulte o documento [Programas e tipos de programas](/help/getting-started/program-setup.md) para obter detalhes sobre programas.
...
1. O ícone de notificações está marcado com o número de incompletos atribuídos no momento [notificações.](/help/using/notifications.md)
...
1. O link de introdução fornece acesso à [integração da jornada de documentação](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/onboarding/journey/overview) para que você possa começar a usar o Cloud Manager.
   * Observe que a jornada de integração foi projetada para AEM as a Cloud Service e não Cloud Service para AMS, mas muitos conceitos são os mesmos.
...
* Número de [problemas de qualidade do código](/help/using/code-quality-testing.md) identificado
* Número de builds
...
A variável **Licença** fornece acesso rápido ao painel de licenças.
...
A seção de frase de chamariz fornecerá informações úteis, dependendo do status do seu programa. Para um novo programa, você pode ver as próximas etapas oferecidas, bem como um lembrete de uma data de publicação, [definido durante a criação do programa.](/help/getting-started/program-setup.md)
