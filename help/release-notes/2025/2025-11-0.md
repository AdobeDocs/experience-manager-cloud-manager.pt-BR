...
Os clientes agora podem integrar seus repositórios Git do Azure DevOps no Cloud Manager, com suporte para repositórios Azure DevOps modernos e VSTS herdados (Visual Studio Team Services).
