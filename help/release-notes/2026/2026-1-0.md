...
O [Experience Hub](https://experienceleague.adobe.com/pt-br/docs/experience-manager-65/content/experience-hub/experience-hub) é um ponto de acesso para o AEM, personalizado para as necessidades da sua organização. Forneça à Adobe detalhes sobre as extensões existentes da interface do usuário do AEM para que elas possam ajudar você a ativá-las no Experience Hub de forma eficiente.
...
Participar do beta? Envie um email para [beta_exphubextensibility@adobe.com](mailto:beta_exphubextensibility@adobe.com) com sua Organização da Adobe e uma breve descrição da personalização que pretende criar.
...
Participar? Envie um email para [beta_quickbuild_cmpipelines@adobe.com](mailto:beta_quickbuild_cmpipelines@adobe.com) com sua ID organizacional e ID do programa da Adobe.
